...
: DISPLAYON LCDWAIT1 DELAY 0C SEND 08 SEND CC SEND C8 SEND ;
...
\( N -- )
: CHARSEND DUP FOURMSB DUP D + SEND 9 + SEND DUP FOURLSB DUP D + SEND 9 + SEND DROP ; \ INVIO DI CARATTERE, FORMATO ASCII

\( NUMERO --- RESTO DIVIDENDO)
: LASTDIGIT 0A /MOD ;

\CODIFICA ASCII DEI NUMERI IN ESADECIMALE E INVIO
\ ( NUMERO ---)
