...
\( I2C -- )
: I2CCLEAR  C SELI2C DUP @ 1 5 LSHIFT OR SWAP ! ; \ PULIRE LA FIFO

\( I2C -- )
: I2CDATALEN 1 SWAP  DLEN SELI2C  ! ; \ STABILIRE IL NUMERO DI BYTE DA INVIARE

\( I2C DATA -- )
: I2CDATA SWAP FIFO SELI2C ! ; \ SETTARE I DATI DA INVIARE

\( I2C -- )
\: I2CRESET  770 SWAP S SELI2C ENABLE ; \ RESETTARE IL FLAG DI DONE  1100000010
: I2CRESET S SELI2C 302 SWAP ! ;
...
: I2CSTART C SELI2C  8080 SWAP ! ;


\( I2C -- )
: I2CDONE BEGIN DUP S SELI2C @ 1 1 LSHIFT AND 0 = WHILE  REPEAT I2CRESET  ; \ASPETTARE CHE L'INVIO TERMINI 
\: I2CDONE  S SELI2C @ 1 1 LSHIFT AND 0 <>  ;
\: I2CDELAY_DONE BEGIN 1000 DELAY I2CDONE UNTIL ;
