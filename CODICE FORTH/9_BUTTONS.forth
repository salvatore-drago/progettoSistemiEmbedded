...
\PAROLA CHE VERIFICA SE UN GPIO ABILITATO IN INPUT MANTIENE IL VALORE (LOGICA INVERSA) ALTO PER 0.5 SEC ---> SE IL BOTTONE E' STATO PREMUTO
\( GPIO -- BOOL)
: PUSHED DUP READLEV 0 = IF INITTI3 BEGIN DUP READLEV 0 = WHILE  REPEAT TIMESTAMP TI3 @ - PRESSIONE >= IF DROP -1 ELSE DROP 0 THEN  ELSE DROP 0 THEN   ;
...
\ ( -- )
: CHANGEROOM 25 PUSHED IF ROOM @ 1 + NROOMS MOD ROOM ! -1 ELSE 0 THEN ;