...
80 CONSTANT 1END \ IL SENSORE MANTIENE L'USCITA ALTA QUANDO HA TERMINAO DI INVIARE I DATI
...
: READS INITACC INITTI1 BEGIN ACC @ N_BITS < TIMESTAMP TI1 @ - ALT < AND  WHILE BEGIN DUP READLEV  0 = WHILE REPEAT ACC @  ZERONEREAD 1 ACC ADDC REPEAT  ;
...
\( MISURA DATI BIT_FINE BIT_INIZIO -- VAL_DEC)
